...
- [SurfSense Extension](https://github.com/MODSetter/SurfSense/tree/main/nbd_browser_extension) (Overall better experience & ability to save private webpages, recommended)
