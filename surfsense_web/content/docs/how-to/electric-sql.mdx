...
|----------|----------|-------------|---------|
| `ELECTRIC_DB_USER` | `nbd_backend/.env` | Database user for Electric replication | `electric` |
| `ELECTRIC_DB_PASSWORD` | `nbd_backend/.env` | Database password for Electric replication | `electric_password` |
